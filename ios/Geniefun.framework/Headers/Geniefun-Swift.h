...
#ifndef GENIEFUN_SWIFT_H
#define GENIEFUN_SWIFT_H
...
#import "/Users/shbaek/Desktop/Sources/adfun-sdk-ios/Geniefun/module/Genie_Bridging_Header.h"
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Geniefun",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8Geniefun13GeniefunUtils")
@interface GeniefunUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
+ (GeniefunUtils * _Nonnull)GetInstance SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC8Geniefun12GeniefunView")
@interface GeniefunView : NSObject <WKNavigationDelegate, WKUIDelegate, APSSPInterstitialVideoAdDelegate, APSSPRewardVideoAdDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
+ (GeniefunView * _Nonnull)GetInstance SWIFT_WARN_UNUSED_RESULT;
- (void)StartVidoeAdWithParentUIView:(UIViewController * _Nonnull)parentUIView;
...
- (void)respondToSwipeGesture:(UIGestureRecognizer * _Nonnull)gesture;
@end
